...
<table>
    ...
    <tr>
        ...
        <td colspan="2" align="center">
            <strong>
                SOAP<br>Для gamedev опасен из-за огромного 
                <br>веса XML и медленной скорости обработки. 
                <br>В реальном времени каждый байт и 
                <br>миллисекунда на счету, а парсинг 
                <br>SOAP-сообщений создаст 
                <br>критическую задержку (лаг).
            </strong>
        </td>
